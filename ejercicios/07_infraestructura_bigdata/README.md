...
07_infraestructura_bigdata/
    ...
    7.3_hadoop_hdfs/          Hadoop: ecosistema, HDFS, almacenamiento distribuido
```
...
| 3 | 7.3 | Hadoop + HDFS | Como almaceno datos de forma distribuida? |

**Recomendacion:** Estudiar en orden. Docker es la base sobre la que se
montan tanto Spark como Hadoop. Spark y Hadoop se complementan.
...
**Hadoop:** HDFS, NameNode, DataNode, bloque, factor de replicacion, rack awareness
...
Siguiente: [7.1 - Docker Compose](./7.1_docker_compose/README.md)
